...
def send_forecast_email(smtp_host, smtp_port, smtp_user, smtp_pass, to_email, forecast_text, subject="NOAA Forecast Update"):
    _LOGGER.debug("Preparing to send forecast email - SMTP: %s:%s, From: %s, To: %s, Subject: %s", 
    ...
    try:
        ...
        _LOGGER.debug("Email sending failed - SMTP: %s:%s, From: %s, To: %s", 
                     smtp_host, smtp_port, smtp_user, to_email)
        return False
