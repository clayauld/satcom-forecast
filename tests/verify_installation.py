...
def check_installation_path():
    ...
    if not installed_path:
        ...
        print("Please ensure you copied the entire 'custom_components/satcom_forecast' folder")
        return False
...
def main():
    ...
    if ha_available:
        ...
        print("3. Try searching for 'SatCom Forecast' or 'satcom' in the integration search")
    else:
