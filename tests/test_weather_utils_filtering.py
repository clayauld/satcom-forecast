...
def mock_periods():
    ...
    return [
        ForecastPeriod(name="Today", detailed_forecast="Sunny", is_daytime=True, start_time="2023-01-01T06:00:00", end_time="2023-01-01T18:00:00"),
        ForecastPeriod(name="Tonight", detailed_forecast="Clear", is_daytime=False, start_time="2023-01-01T18:00:00", end_time="2023-01-02T06:00:00"),
        ForecastPeriod(name="Tuesday", detailed_forecast="Sunny", is_daytime=True, start_time="2023-01-02T06:00:00", end_time="2023-01-02T18:00:00"),
        ForecastPeriod(name="Tuesday Night", detailed_forecast="Clear", is_daytime=False, start_time="2023-01-02T18:00:00", end_time="2023-01-03T06:00:00"),
        ForecastPeriod(name="Wednesday", detailed_forecast="Sunny", is_daytime=True, start_time="2023-01-03T06:00:00", end_time="2023-01-03T18:00:00"),
        ForecastPeriod(name="Wednesday Night", detailed_forecast="Clear", is_daytime=False, start_time="2023-01-03T18:00:00", end_time="2023-01-04T06:00:00"),
    ]
