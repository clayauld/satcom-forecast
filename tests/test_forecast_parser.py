...
class TestForecastParser:
    ...
    def test_smoke_conditions(self):
...
Tonight: Widespread haze. Low around 41. Southeast wind around 15 mph."""
        areas_smoke_forecast = "This Afternoon: Areas of smoke. Mostly sunny, with a high near 70."
    ...
    def test_explicit_percentages(self):
...
Tonight: Showers likely, mainly between 7pm and 10pm, then rain after 10pm. Low around 41. Southeast wind around 15 mph. Chance of precipitation is 80%."""
    ...
    def test_smoke_with_precipitation(self):
...
Tonight: Showers, mainly before 1am, then rain after 1am. Areas of smoke. Mostly cloudy, with a low around 57. Southeast wind around 5 mph. Chance of precipitation is 80%."""
    ...
    @pytest.mark.parametrize("description,forecast_text,expected_event", [
        ("Fog conditions", "Tonight: Dense fog. Low around 35. Calm wind.", "Fog(90%)"),
        ("Thunderstorm", "Today: Thunderstorms likely. High near 75. Southeast wind 10 mph.", "Thunderstorms likely"),
        ("Wind conditions", "Tonight: Windy. Low around 45. Northwest wind 20 to 30 mph.", "Windy"),
        ("Snow", "Today: Snow likely. High near 25. North wind 15 mph.", "Snow likely"),
        ("Freezing rain", "Tonight: Freezing rain. Low around 28. Northeast wind 10 mph.", "Freezing rain"),
    ])
    def test_weather_event_detection(self, description, forecast_text, expected_event):
    ...
    def test_temperature_wind_extraction(self):
...
Monday Night: Rain. Low around 35."""
    ...
    def test_smoke_probability_levels(self):
    ...
    def test_summary_with_temp_wind(self):
