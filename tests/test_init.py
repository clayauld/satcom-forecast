...
async def test_async_setup_entry(mock_hass, mock_coordinator):
    ...
    with patch(
        "custom_components.satcom_forecast.SatcomForecastCoordinator",
...
async def test_async_reload_entry(mock_hass):
    ...
    with patch(
        "custom_components.satcom_forecast.async_unload_entry",
        side_effect=return_future,
    ) as mock_unload, patch(
        "custom_components.satcom_forecast.async_setup_entry", side_effect=return_future
    ) as mock_setup:
