...
def test_multiple_percentages_in_forecast():
    ...
    forecast_text2 = "30% chance of snow in the morning, 60% chance of rain in the afternoon"
...
def test_no_percentage_near_event():
    ...
    forecast_text = "rain likely with temperatures in the 70s. " + "x" * 100 + " 90% humidity expected"
    chance = weather_utils.infer_chance("rain", forecast_text, period)
